        ...
        <section id="hero-mst-ldh">
            <div class="container">
                ...
                <div  class="house-cards-cont">
                    <div v-if="data.length == 0" class="notFoundSec">
                        ...
                        <p>We couldn't find what your searched for.<br> Try searching again.</p>
                    </div>
                    <house-card @opencard="openCard" @update_house="savingPost" v-for="house in data" :id_house="house.id" :user="user_auth" :saved_list="house.saved" :images="house.images" :location="house.city" :title="house.title" :price="house.price" :surface="house.tsurface" :bedNum="house.bedroom" :toilletes="house.toilettes"></house-card>
                </div>
                <pagination-section :next="next" :prev="prev" :page="page" url_path="/home/search/"></pagination-section>
            </div>
        </section>

    `,
    props : ["csrf_value","data","user_auth"  ,"next","prev","page","url_path"]
    ,
    data() {
        return {
            // Data Goes Here
